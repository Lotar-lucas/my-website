    ...
    <section id="sobre" className="bg-blue-200 px-6 py-24">
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-start md:items-center gap-12">
        <div className="md:w-1/2" data-aos="fade-up">
          <h1 className="text-3xl md:text-4xl text-blue-900 font-extrabold mb-6">Sobre mim</h1>

          <p className="text-lg leading-relaxed text-blue-800 mb-6">
            Sou desenvolvedor back-end com mais de 3 anos de experiência no desenvolvimento de
            sistemas
            <strong> escaláveis, seguros e de alta performance</strong>. Tenho como foco entregar
            soluções bem arquitetadas, que resolvam problemas reais de forma eficiente e sustentável
            ao longo do tempo.
          </p>

          <p className="text-lg leading-relaxed text-blue-800 mb-6">
            No dia a dia, atuo com <strong>JavaScript, TypeScript e Node.js</strong>, além de
            serviços em nuvem (<strong>AWS</strong>), bancos de dados relacionais, mensageria e
            conteinerização. Mais do que dominar ferramentas, busco compreender profundamente os
            desafios técnicos e propor soluções que façam sentido no contexto do produto e do
            negócio.
          </p>

          <p className="text-lg leading-relaxed text-blue-800 mb-6">
            Estou em constante evolução, com foco em{' '}
            <strong>arquitetura de software, system design, padrões de projeto</strong> e boas
            práticas em ambientes distribuídos. Acredito que software bem feito é resultado de um
            equilíbrio entre
            <strong> clareza técnica, colaboração e melhoria contínua</strong>.
          </p>

          <p className="text-lg leading-relaxed text-blue-800 ">
            Se você busca alguém comprometido com <strong>qualidade, evolução profissional</strong>{' '}
            e <strong>impacto real no time</strong>, ficarei feliz em conversar.
          </p>
